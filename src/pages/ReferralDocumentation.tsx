...
const ReferralDocumentation = () => {
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="bg-muted p-4 rounded-lg font-mono text-sm">
                    {`https://100million2everyone.com/?return_url=https://yoursite.com/success`}
                  </div>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">2. With Custom Site Name</h4>
                  <div className="bg-muted p-4 rounded-lg font-mono text-sm">
                    {`https://100million2everyone.com/?return_url=https://yoursite.com/success&site_name=Your%20App`}
                  </div>
                </div>
              </div>
            </CardContent>
              ...
              <div>
                ...
                <div className="bg-muted p-4 rounded-lg">
                  <code className="text-sm">
                    {`<a href="https://100million2everyone.com/?return_url=https://yoursite.com/welcome&site_name=My%20App" 
   target="_blank" 
  ...
  const gameUrl = \`https://100million2everyone.com/?return_url=\${returnUrl}&site_name=\${siteName}\`;
  ...
  const handleClick = () => {
    ...
    window.open(\`https://100million2everyone.com/?\${params}\`, '_blank');
  };
